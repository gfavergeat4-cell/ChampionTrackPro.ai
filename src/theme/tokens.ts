...
// `da` (tokens DA v2) a ete supprime le 15 aout 2026 : zero consommateur
// dans tout le graphe d'imports, et il faisait doublon avec `courtlight`,
// qui fait autorite depuis le doc 06. Historique : git.
